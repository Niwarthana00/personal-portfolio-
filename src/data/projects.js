export const projectData = [
...

    {
        ...
        link: 'https://github.com/Niwarthana00/Techfix-web-application-',
    },
    {
        id: 5,
        category: 'UI/UX',
...

    {
        ...
        link: 'https://github.com/Niwarthana00/gobus',
...

    {
        ...
        mainImage: '/assets/blockchain/main.png',
        thumbnails: [
            '/assets/blockchain/1.JPG',
            '/assets/blockchain/2.JPG',
            '/assets/blockchain/3.JPG',
            '/assets/blockchain/4.JPG',
        ],
    ...
    },
    {
        ...
        mainImage: '/assets/seatbook/main.png',
        thumbnails: [
            '/assets/seatbook/11.JPG',
            '/assets/seatbook/12.JPG',
            '/assets/seatbook/13.JPG',
            '/assets/seatbook/14.JPG',
        ],
        ...
        link: 'https://github.com/Niwarthana00/ticket_booking',
    },
    {
        id: 13,
        category: 'Mobile App',
        title: 'Sahana - Disaster Relief Coordination App',
        mainImage: '/assets/sahana/mainimg.png',
        thumbnails: [
    ...
    },
    {
        ...
        mainImage: '/assets/AI-summery/main.png',
        thumbnails: [
            '/assets/AI-summery/1.png',
            '/assets/AI-summery/2.png',
            '/assets/AI-summery/3.png',
            '/assets/AI-summery/4.png',
        ],
    ...
    },
    {
        ...
        title: 'Ecommerce Streaming Pipeline',
        mainImage: '/assets/olist/main.png',
        thumbnails: [
            '/assets/olist/1.png',
            '/assets/olist/2.png',
            '/assets/olist/3.png',
        ],
        technologies: ['Kafka', 'Spark', 'Debezium', 'PostgreSQL', 'Docker'],
        overview:
            'A real-time CDC pipeline that ingests the Olist Brazilian E-Commerce dataset from a PostgreSQL database and streams it in real time through Kafka into a clean analytics warehouse. Any insert or update in the source DB propagates to the gold analytics layer within ~10 seconds automatically.',
        techStack: {
            frontend: 'Looker Studio Dashboard for live reporting',
            backend: [
                'Apache Kafka (Confluent)',
                'Apache Spark 3.5 Structured Streaming',
                'Debezium 2.7 + PostgreSQL pgoutput',
                'PostgreSQL 14+',
                'Docker Compose + Taskfile'
            ],
        },
        features: {
            dataLayers: [
                'Silver Layer: Raw, cleaned mirror of source tables (customers, orders, products, etc.) upserted on every Kafka batch.',
                'Gold Layer: 7 materialized views (sales monthly/daily, customer metrics, product performance, etc.) auto-refreshed whenever orders or payments update.'
            ],
            infrastructure: [
                'Change Data Capture: Debezium snapshots source DB and pushes records via Kafka.',
                'Stream Processing: Spark structured streaming populates Silver and Gold layers automatically.',
                'Orchestration: Fully dockerized environment with Taskfile for easy execution and management.'
            ]
        },
